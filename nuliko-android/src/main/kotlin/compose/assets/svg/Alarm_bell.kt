...
public val Svg.Alarm_bell: ImageVector
    get() {
        if (_alarm_bell != null) {
            return _alarm_bell!!
        }
        _alarm_bell = Builder(name = "Alarm_bell", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _alarm_bell: ImageVector? = null
